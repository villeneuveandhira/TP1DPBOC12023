...
def main():
    ...
    ##
    # Data Mahasiswa
    student.append(Mahasiswa("Afri", "Male", "2001023", "Notebook"))
    student.append(Mahasiswa("Anin", "Female", "2004506", "Laptop"))
    # Data Dosen
    teacher.append(Dosen("Mrs.Rose", "Female", "2658", "Laptop"))
    # Data BEM
